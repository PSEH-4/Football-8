...
public class StandingsController {
	...
	public String getStandings(@RequestParam("countryName") String countryName,
				@RequestParam("leagueName") String leagueName,
				 @RequestParam("teamName") String teamName,Model model) throws StandingNotFoundException {
		Satnding standing = standingService.getStanding(countryName, leagueName, teamName);
