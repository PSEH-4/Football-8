...
public class Satnding {
	...
	public Satnding(int country_id, String country_name, int league_id, String league_name, int team_id,
	...
	public String toString() {
		return "Satnding [country_id=" + country_id + ", country_name=" + country_name + ", league_id=" + league_id
